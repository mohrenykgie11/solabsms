...
body {
  margin: 0;
  font-family: "Roboto","Nunito", -apple-system, BlinkMacSystemFont, "Segoe UI"," Roboto", "Helvetica Neue", Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
  font-size: 1rem;
  font-weight: 400;
  line-height: 1.5;
  color: #858796;
...
.bg-gradient-primary {
  ...
  background-image: linear-gradient(180deg, #004b82 10%, #004b82 100%);
